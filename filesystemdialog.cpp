...
CFileSystemDialog::CFileSystemDialog()
{
    ...
    connect(cancelButton, &QPushButton::clicked, this, &CFileSystemDialog::close);
    ...
    connect(treeView, &CFileTreeView::signalFilePathSelected, [this](QString filePath){this->path = filePath; });
}
